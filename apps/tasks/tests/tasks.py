...
from apps.tasks.serializers.task_serializer import CreateUpdateTaskSerializer, TaskDetailSerializer
...
class CreateTaskTestCase(TestCase):
    ...
    def test_short_description(self):
        ...
        self.assertEqual(serializer.errors['description'][0], "The description of the task couldn't be less than 50 characters")
